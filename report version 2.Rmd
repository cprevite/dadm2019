...
- results seems acceptable, waiting to compare with others models
...
- not the best model in term of accuracy
- but easy to understand and to show to client
- on the right hand side there are some really good predictions with a lot of observations in this category (see percentage)
- also success to predict a defectuous product with 100% of probability (the 4th categorie) 
- cylinder_no really important as it it the first split
