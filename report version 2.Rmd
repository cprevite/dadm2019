...
trainRowNumbers <- createDataPartition(bands2$band_type, p=0.75, list=FALSE)

# Step 2: Create the training  dataset
trainData <- bands2[trainRowNumbers,]

# Step 3: Create the test dataset
testData <- bands2[-trainRowNumbers,]
...
bandsSmall <- bands1[c(1,2,4,6,7,9,12,16,18,23,24,26, 27)] # only the elbow from Boruta and important variable from RF
# Create the training and test datasets
set.seed(100)
...
# Step 2: Create the training  dataset
trainDataSmall <- bandsSmall[trainRowNumbersSmall,]

# Step 3: Create the test dataset
testDataSmall <- bandsSmall[-trainRowNumbersSmall,]
