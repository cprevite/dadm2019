...
The plot  lists the variables  in the order of importance. According to the model, the variables 
- 'blade_pressure',
- 'press',
- 'press_speed', 
- 'ink_pct', 
...
```{r, fig.height=c(7), fig.width=c(10)}
grid.arrange(plot_var_RF, plot_var_Nn, plot_var_SVM2, nrow=1, ncol=3)
```
