...
To write why we consider the useless. better with names. like this we don't have to count and it's also easier for the reader
```{r}

variables_to_detele = rownames(subset(info_boruta, info_boruta$decision=="Rejected"))

bands <-
  bands[, which(
    !names(bands) %in% variables_to_detele
  )]
