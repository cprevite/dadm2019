...
After a close verification of the boxplots and the summary for each variable, it has been concluded that there are no error measurements and neither error entries in the data. Please refer to the Annexe1,to see outputs of the analysis.
