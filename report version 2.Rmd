...
In order to prevent a bad value in specificity in the further models, it has been decided that the number of each response variable need to be the same. This way, more weight is given to negative classe **BAND**.
...
confusionMatrix(rf.pred, testData$band_type, positive = 'BAND')
```
